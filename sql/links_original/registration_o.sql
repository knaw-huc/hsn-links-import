...
--
-- Table structure for table `registration_o`
--

DROP TABLE IF EXISTS `registration_o`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `registration_o` (
  ...
  KEY `id_persist_registration` (`id_persist_registration`)
) ENGINE=MyISAM AUTO_INCREMENT=29865088 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
-- Dump completed on 2021-09-16 16:10:54
