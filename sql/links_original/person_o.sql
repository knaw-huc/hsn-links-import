...
--
-- Host: localhost    Database: links_original
-- ------------------------------------------------------
...
--
-- Table structure for table `person_o`
--

DROP TABLE IF EXISTS `person_o`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `person_o` (
  ...
  `living_location` varchar(120) COLLATE utf8_bin DEFAULT NULL,
  ...
  `death_day` tinyint(3) DEFAULT NULL,
  `death_month` tinyint(3) DEFAULT NULL,
  `death_year` smallint(5) DEFAULT NULL,
  `death_location` varchar(120) COLLATE utf8_bin DEFAULT NULL,
  `mar_date` varchar(20) COLLATE utf8_bin DEFAULT NULL,
  `mar_day` tinyint(3) DEFAULT NULL,
  `mar_month` tinyint(3) DEFAULT NULL,
  `mar_year` smallint(5) DEFAULT NULL,
  `mar_location` varchar(120) COLLATE utf8_bin DEFAULT NULL,
  `divorce_date` varchar(20) COLLATE utf8_bin DEFAULT NULL,
  `divorce_day` tinyint(3) DEFAULT NULL,
  `divorce_month` tinyint(3) DEFAULT NULL,
  `divorce_year` smallint(5) DEFAULT NULL,
...
) ENGINE=MyISAM AUTO_INCREMENT=106150375 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
-- Dump completed on 2021-09-16 16:11:08
